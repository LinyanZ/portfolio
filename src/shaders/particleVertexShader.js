export default /*html*/ `
  ...
  void main() { 
    ...
    vec3 fromCamera = randomPosition - uCameraPos;
    float projectedAlongLookAt = dot(fromCamera, uCameraLookAt) / length(uCameraLookAt);

    vDistance = abs(projectedAlongLookAt - uFocus);
    gl_PointSize = vDistance * uPointSize;
  }
`;
